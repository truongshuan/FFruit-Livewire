                                        ...
                                        <td>
                                            ...
                                            {{-- <table cellpadding="0" cellspacing="0" class="mt-3">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>{{ $item->products->slug }}</th>
                                                        <th><img src="{{ Storage::disk('products')->url($item->products->path_image) }}"
                                                                alt="{{ $item->products->slug}}" width="100"></th>
                                                        <th>{{ $item->products->name }}</th>
                                                        <th>{{ $item->quantity }}</th>
                                                        <th>
                                                            ...
                                                            @else
                                                            <p class="h5">{{ number_format($item->products->price, 0,
                                                                ',', '.') .
                                                                ' VND' }}</p>
                                                            @endif
                                                        </th>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block">
                                    ...
                                    <br> And <a href="{{ config('app.url') }}">unsubscribe link</a> here.
                                </td>
                            </tr>
                            <tr>
                                <td class="content-block powered-by">
                                    Powered by <a href="{{ config('app.url') }}">FFruit - Coppyright</a>.
                                </td>
                            </tr>
                        </table>
                    </div>
